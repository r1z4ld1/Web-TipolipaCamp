...
@section('content')
    @php
        $roleName = auth()->user()->getRoleNames()->first() ?? 'Petugas';
    @endphp
    ...
    <div class="dashboard-page">
        <div class="page-header">
            <div class="page-title-wrap">
                ...
                <p>Ringkasan operasional alat, penyewaan, dan pengembalian CampRent.</p>
            </div>

            <a href="{{ route('petugas.penyewaan.index') }}" class="btn-primary-top">
        ...
        <div class="dashboard-grid">
            <div class="dashboard-welcome-card">
                <div class="welcome-content">
                    ...
                    <p>
                        ...
                        mengelola data alat camping, memproses penyewaan, mencatat pengembalian,
                        dan melihat laporan operasional.
                    </p>
            ...
            <div class="dashboard-role-card">
                ...
                <span>Petugas dapat mengelola data operasional penyewaan alat camping.</span>
            </div>
        </div>
        ...
        <div class="dashboard-module-card">
            <div class="module-header">
                <div>
                    <h3>Menu Operasional Petugas</h3>
                    <p>Akses cepat ke modul operasional yang tersedia.</p>
                </div>
            </div>
            ...
            <div class="module-grid">
                @can('kategori.index')
                    <a href="{{ route('admin.kategoris.index') }}" class="module-item">
                        ...
                        <div>
                            <h4>Kategori Alat</h4>
                            <p>Kelola kategori perlengkapan camping.</p>
                        </div>
                    </a>
                @endcan
                ...
                @can('barang.index')
                    <a href="{{ route('admin.barangs.index') }}" class="module-item">
                        ...
                        <div>
                            <h4>Alat Camping</h4>
                            <p>Kelola stok, harga, kondisi, dan foto alat.</p>
                        </div>
                    </a>
                @endcan
                ...
                @can('penyewaan.index')
                    <a href="{{ route('petugas.penyewaan.index') }}" class="module-item">
                        ...
                        <div>
                            <h4>Penyewaan</h4>
                            <p>Kelola pengajuan dan status penyewaan.</p>
                        </div>
                    </a>
                @endcan
                ...
                @can('pengembalian.index')
                    <a href="{{ route('petugas.pengembalian.index') }}" class="module-item">
                        ...
                        <div>
                            <h4>Pengembalian</h4>
                            <p>Lihat data alat yang sudah dikembalikan.</p>
                        </div>
                    </a>
                @endcan
                ...
                @can('laporan.index')
                    <a href="{{ route('laporan.index') }}" class="module-item">
                        ...
                        <div>
                            <h4>Laporan</h4>
                            <p>Lihat dan cetak laporan penyewaan.</p>
                        </div>
                    </a>
                @endcan
            </div>
