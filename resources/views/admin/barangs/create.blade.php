...
@section('page-subtitle', 'Tambahkan data alat camping beserta foto, stok, dan harga sewa')

@section('content')
    <div class="card-modern p-4">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
            <div>
                <h2 class="fw-bold mb-1">Form Tambah Alat Camping</h2>
                <p class="text-muted mb-0">
                    Isi data alat camping yang akan disewakan.
                </p>
            </div>
        ...
        <form action="{{ route('admin.barangs.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-12 col-xl-4">
                    <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 20px; padding: 18px; margin-bottom: 18px;">
                        ...
                        <div style="width: 100%; height: 220px; border-radius: 18px; background: #e2e8f0; display: flex; align-items: center; justify-content: center; overflow: hidden; margin-bottom: 14px; border: 1px dashed #94a3b8;">
                            ...
                            <div id="placeholderFoto" style="text-align: center; color: #64748b;">
                                <i class="bi bi-image" style="font-size: 38px;"></i>
                                <div style="font-weight: 700; margin-top: 8px;">Preview Foto</div>
                                <div class="small">JPG, PNG, WEBP maksimal 5MB</div>
                            </div>
                        </div>
            ...
            <div style="background: #eff6ff; border: 1px solid #bfdbfe; border-radius: 16px; padding: 16px; margin-bottom: 24px;">
                ...
                <p class="text-muted small mb-0">
                    Gunakan foto alat yang jelas dan sesuai dengan kondisi barang agar penyewa dapat melihat detail alat camping sebelum melakukan penyewaan.
                    Format foto yang didukung adalah JPG, PNG, JPEG, dan WEBP dengan ukuran maksimal 5MB.
                </p>
            </div>
