...
@section('page-subtitle', 'Perbarui kategori perlengkapan camping')

@section('content')
    <div class="card-modern p-4">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
            <div>
                <h2 class="fw-bold mb-1">Form Edit Kategori</h2>
                <p class="text-muted mb-0">
                    Perbarui data kategori alat camping.
                </p>
            </div>
        ...
        <form action="{{ route('admin.kategoris.update', $kategori->id) }}" method="POST">
            ...
            <div style="margin-bottom: 18px;">
                ...
                <textarea id="deskripsi"
                          ...
                          style="width: 100%; padding: 13px 15px; border: 1px solid #cbd5e1; border-radius: 14px; outline: none; resize: vertical;">{{ old('deskripsi', $kategori->deskripsi) }}</textarea>
            </div>
            ...
            <div style="background: #eff6ff; border: 1px solid #bfdbfe; border-radius: 16px; padding: 16px; margin-bottom: 24px;">
                ...
                <p class="text-muted small mb-0">
                    Slug saat ini adalah <strong>{{ $kategori->slug }}</strong>.
                    Jika nama kategori diubah, slug akan ikut diperbarui otomatis.
                </p>
            </div>
